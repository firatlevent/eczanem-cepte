...
class PersonelKayit extends StatefulWidget {
  @override
  _PersonelKayitState createState() => _PersonelKayitState();
}

class _PersonelKayitState extends State<PersonelKayit> {
  ...
  final maasC = TextEditingController();
  _personelKaydet() async {
    await Services.personelEkle(
      adC.text,
      soyadC.text,
      tcC.text,
      adressC.text,
              ...
              child: ListView(children: <Widget>[
                ...
                Padding(
                  ...
                  child: TextFormField(
                    controller: maasC,
                    validator: Validators.compose([
                      Validators.required("Maaş giriniz."),
                      Validators.patternRegExp(
                          RegExp(r"^[0-9]+$"), 'Sadece sayı içerebilir.'),
                    ]),
                    style: TextStyle(color: Colors.black),
                        ...
                        if (_key.currentState.validate()) {
                          ...
                          return showDialog<bool>(
                            ...
                            builder: (c) => AlertDialog(
                              title: Text('Bildirim'),
                              content: Text('Personel eklenmiştir.'),
                              actions: [
                                FlatButton(
                                  child: Text('Tamam'),
                                  onPressed: () {
